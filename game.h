...
public:
    ...
    int containmentLevel = 0;               // ступень удерживающей ячейки (§31.4)
    int hullPlating = 0;                    // слоёв нейтрониевой брони (§31.4)
    ...
    // Ёмкость следующей ступени ячейки и её цена (0, если ступеней больше нет).
