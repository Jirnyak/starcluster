...
int main(int argc, char** argv) {
    ...
    // Размер окна берём у SDL ЗДЕСЬ, а не полагаемся на winW/winH из
    // SDL_CreateWindow: пока игрок листал оболочку, окно могло уехать в
    // полноэкранный режим (или система восстановила приложение уже развёрнутым).
    // SDL_WINDOWEVENT_SIZE_CHANGED об этом сообщил ОБОЛОЧКЕ, а главный цикл его
    // не увидел и рисовал партию в 1200x900 в левом верхнем углу до первого
