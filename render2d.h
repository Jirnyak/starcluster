...
struct Palette {
    ...
    // Хайтек-этаж (§31): экзотика ни на что в игре не похожа, и цвет у неё
    // тоже свой — ни один другой элемент интерфейса фиолетовым не рисуется.
    SDL_Color violet = {186, 132, 248, 255};
};
